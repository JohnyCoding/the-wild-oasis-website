...
export default async function Page() {
    ...
    return (
        <div className="grid grid-cols-2 items-center gap-x-24 gap-y-32 text-lg md:grid-cols-5">
            ...
            <div className="relative col-span-2 aspect-square md:col-span-2">
                <Image
                    src="/about-1.jpg"
                    fill
            ...
            <div className="col-span-2 md:col-span-3">
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        <Link
                            href="/cabins"
                            className="mt-4 inline-block bg-accent-500 px-8 py-5 text-lg font-semibold text-primary-800 transition-all hover:bg-accent-600 max-md:w-full max-md:text-center"
                        >
